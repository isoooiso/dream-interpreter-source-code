  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-indigo-950 to-purple-950 flex items-center justify-center px-4">
      <div className="bg-slate-900/70 border border-indigo-500/20 rounded-3xl shadow-2xl p-10 max-w-xl w-full text-center fade-in">
        ...
        <h1 className="text-3xl font-extrabold text-slate-50 tracking-tight">Dream Interpreter</h1>
        <p className="text-slate-300 mt-3">
          Describe your dream. AI will interpret its meaning and rate how interesting it is.
        </p>
        ...
        <div className="mt-8">
          <button
            ...
            className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white px-8 py-3 rounded-full font-bold text-lg hover:shadow-lg transition-all duration-300 hover:scale-[1.02] disabled:opacity-60 disabled:hover:scale-100"
          >
